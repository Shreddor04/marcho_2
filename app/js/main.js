$(function(){
    ...
    // удаляет все класса с актив 
        $(this).addClass('product-tabs__top-item--active')
    //при нажатии на любой из линков добовляет класс актив  

        $('.product-tabs__content-item').removeClass('product-tabs__content-item--active');
    // удаляет все класса с актив
        $($(this).attr('href')).addClass('product-tabs__content-item--active');
    // при нажатии он будет вытаскивать атрибут href='#tab-1' и сравнивает его с нижним контентом id
